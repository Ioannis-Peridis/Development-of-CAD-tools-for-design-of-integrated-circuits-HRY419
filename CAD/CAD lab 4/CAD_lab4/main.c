...
//and gives as output routing and compaciton solution for the gates by using an algorithm
//and also the number of rows in this solution
//Before giving the routing , it does the placement with the Monte Carlo/Simulated Annealing Method
//so it finds a solution of routing very close to the optimal solution
//****************************************************************************************
...
//this function is used to swap 2 rows in a 2 dimensional array
 ...
 int RouteAndCompact(int numOfShells,int routing[][3],int placement[]){
    ...
    */
    ...
    printf("\n***The Length of the Biggest Wire (measured in std shells distance) is %d***\n",maxLength);
